...
def create_refresh_token(data: dict):
    """
    Создаёт refresh-token с длительным сроком действия и token_type="refresh". 
    """
    to_encode = data.copy()
...
async def get_current_buyer_or_admin(current_user: UserModel = Depends(get_current_user)):
    """
